...
namespace MapleServer2.PacketHandlers.Game {
    public class ResponseKeyHandler : GamePacketHandler {
        ...
        public override void Handle(GameSession session, PacketReader packet) {
            ...
            session.Send(UserEnvPacket.Send02());
            ...
            // SendMeretMarket f(0xC9), Fishing f(0x07), SendPvp f(0x16,0x17), ResponsePet f(0x07), 0xF6
            // CharacterAbility
            // E1 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
            // SendDefaultKeys
            session.Send(PacketWriter.Of(SendOp.KEY_TABLE).WriteByte(0x00).WriteBool(true));
